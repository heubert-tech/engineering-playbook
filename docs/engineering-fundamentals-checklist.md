...
- [ ] All items are tracked in Jira Board.
- [ ] The board is organized as (Product Development board, Errors board, Infra board, Product Discovery).
...
- [ ] The Product Owner (+ Dev Lead/Others) are responsible for backlog management and refinement.
- [ ] A working agreement is established between team members and clients.
...
- [ ] Linters/Code Analyzers and successful builds for PR merges are set up.
